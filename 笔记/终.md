...
https://blog.csdn.net/qq_23012315/article/details/82492165  okhttp3中的设计模式

https://juejin.cn/post/6898145227765186567  面试官:Okhttp连接池是咋实现的?          

https://blog.csdn.net/iblade/article/details/51107308 单例模式的优缺点

https://blog.csdn.net/u012845311/article/details/73379573  动态规划实例（九）：最小硬币找零数
...
1. Launcher进程通过Binder机制发送消息给 system_server 进程。在 system_server 中，由AMS通过 socket 通信告知 Zygote 进程 fork 子进程
...
ApplicationThread是ActivityThread的内部类，ApplicationThread 是 APP进程的Binder线程
...
————————————————
会判断要启动 App 的进程是否存在，存在则通知进程启动 Activity，否则就先将进程创建出来

不是反射创建Activity，而是Instrumentation调用类加载器，并且是Instrumentation调用oncreate方法

进程内调用时，就是直接调用实现类的方法，跨进程调用时，客户端调用代理类的方法
...
作者：Awanwan
链接：https://www.jianshu.com/p/732c18699b9e
来源：简书
