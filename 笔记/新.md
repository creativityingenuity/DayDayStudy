...
setContentView流程
https://zhuanlan.zhihu.com/p/126747739
https://www.jianshu.com/p/a9dd5a01d2e8
大图加载优化，原理。
https://leo-wxy.github.io/2020/11/18/Android-SharedPreferences%E7%AE%80%E6%9E%90/#%E7%BA%BF%E7%A8%8B%E5%AE%89%E5%85%A8
https://juejin.cn/post/6844903729217404935#heading-6
...
4.调用对应的构造函数进行初始化
5.在构造函数中，第一行会先到调用父类中构造函数进行初始化，在子类的构造函数中一定有一个super()，调用父类的默认无参数的构造函数。如果父类有形参的构造函数，也可以使用super(2)进行调用有参的构造函数。
