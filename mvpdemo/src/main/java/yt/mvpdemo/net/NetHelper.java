...
public class NetHelper {
    ...
    public static APIServers apiServers;
    private int maxCacheTime = 60 * 60 * 24 * 15;
    ...
    private void initRetrofit() {
        ...
        //缓存 50M
        Cache cache = new Cache(new File(MVPApplication.getInstance().getExternalCacheDir(), "httpCache"), 1024 * 1024 * 100);
